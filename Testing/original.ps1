...
$decryptedString1 = hehe -EncryptedText $encryptedString1 -Key $key -InitializationVector $iv
$decryptedString2 = hehe -EncryptedText $encryptedString2 -Key $key -InitializationVector $iv

Write-Output $decryptedString1
Write-Output $decryptedString2
Write-Output $repalcement1
Write-Output $repalcement2
